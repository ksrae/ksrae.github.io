...
일반적으로 @Decorator와 같이 앞에 @을 붙여서 호출하며, 클래스, 함수, 변수, 심지어 함수의 파라미터에도 적용할 수 있으나 각각의 적용하는 파라미터가 다르므로 유의하여야 합니다.<br/><br/>
...
만일 값이 true라면 클래스는 호출되는 즉시 `name = 'SM6', price = 10000, color = 'black' ` 값을 가지고,<br/>
...
propName의 경우 여기에서는 editable Decorator가 적용된 `test02`를 갖습니다.<br/>
...
```
위의 예제에서 methodName은 test를 가지며, paramIndex는 0값을 가집니다.<br/><br/>
